  ...
  return (
    <html lang="en">
      <body className="bg-white dark:bg-slate text-slate dark:text-white font-sans bg-white dark:bg-slate-800">
        <section className="flex flex-col height-screen">
        ...
        {children}
        <footer className="flex justify-end items-center px-4 py-2 text-sm text-gray-500 static mt-8 bottom-0 w-full">
          <div className="flex justify-center">
            <Link
